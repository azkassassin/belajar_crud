...
if(isset($_POST['aksi'])) {
    if($_POST['aksi'] == "add") {
        ...
        $query = "UPDATE tb_siswa SET nisn='$nisn' , nama_siswa='$nama_siswa' , jenis_kelamin
            ='$jenis_kelamin' , alamat='$alamat', foto = '$foto' WHERE id_siswa='$id_siswa';";
        $sql = mysqli_query($conn, $query);
        header("location: index.php");
    }
}
...
if (empty($_POST['nisn']) || empty($_POST['nama_siswa'])) {
    die('Error: NISN dan Nama Siswa wajib diisi.');
}
